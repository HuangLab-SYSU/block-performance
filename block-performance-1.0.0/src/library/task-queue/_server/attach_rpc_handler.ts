...
export function attach_rpc_handler(plog: Logger, opt: { router: express.Router }) {
    ...
    router.post("/library/task-queue/all-cycle", (req, res) => {
    ...
    router.post("/library/task-queue/all-status", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/queue-cycle", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/queue-run", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/queue-status", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/task-add", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/task-add-wait", (req, res) => {
        const input = req.body;
    ...
    router.post("/library/task-queue/task-wait", (req, res) => {
        const input = req.body;
