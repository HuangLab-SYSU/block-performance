...
export async function rpc_docker_build_script_make<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_docker_build_script_make");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/docker-build-script-make`,
                data: input
            },
            {
