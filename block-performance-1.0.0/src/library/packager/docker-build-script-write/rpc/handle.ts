...
import { docker_build_script_write as target } from "../export.js";
...
export async function handle_rpc_docker_build_script_write<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_docker_build_script_write");
