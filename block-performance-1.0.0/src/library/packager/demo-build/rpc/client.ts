...
export async function rpc_demo_build<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_demo_build");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/demo-build`,
                data: input
            },
            {
