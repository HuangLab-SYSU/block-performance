...
import { demo_build as target } from "../export.js";
...
export async function handle_rpc_demo_build<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_demo_build");
