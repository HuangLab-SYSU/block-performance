...
export { rpc_demo_build } from "./rpc/client.js";
export { Input as DemoBuildInput, Output as DemoBuildOutput } from "./type.js";
export { make_input as make_demo_build_input, make_output_ok as make_demo_build_output_ok } from "./tool/index.js";
...
export async function demo_build<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("packager", "demo-build");
