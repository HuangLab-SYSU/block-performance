...
export async function rpc_dependency_analyze<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_dependency_analyze");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/dependency-analyze`,
                data: input
            },
            {
