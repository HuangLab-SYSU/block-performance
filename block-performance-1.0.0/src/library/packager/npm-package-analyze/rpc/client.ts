...
export async function rpc_npm_package_analyze<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_npm_package_analyze");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/npm-package-analyze`,
                data: input
            },
            {
