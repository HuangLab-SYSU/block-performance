...
export async function rpc_dockerfile_make<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_dockerfile_make");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/dockerfile-make`,
                data: input
            },
            {
