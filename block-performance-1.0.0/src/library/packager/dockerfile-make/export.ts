...
export { rpc_dockerfile_make } from "./rpc/client.js";
export { Input as DockerfileMakeInput, Output as DockerfileMakeOutput } from "./type.js";
export { make_input as make_dockerfile_make_input, make_output_ok as make_dockerfile_make_output_ok } from "./tool/index.js";
...
export async function dockerfile_make<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("packager", "dockerfile-make");
