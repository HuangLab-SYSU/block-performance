...
export { rpc_clear } from "./rpc/client.js";
export { Input as ClearInput, Output as ClearOutput } from "./type.js";
export { make_input as make_clear_input, make_output_ok as make_clear_output_ok } from "./tool/index.js";
...
export async function clear<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("packager", "clear");
    try {
