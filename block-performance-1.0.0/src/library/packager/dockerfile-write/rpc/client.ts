...
export async function rpc_dockerfile_write<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_dockerfile_write");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/dockerfile-write`,
                data: input
            },
            {
