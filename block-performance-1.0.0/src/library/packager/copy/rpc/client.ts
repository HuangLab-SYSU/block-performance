...
export async function rpc_copy<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_copy");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/packager/copy`,
                data: input
            },
            {
