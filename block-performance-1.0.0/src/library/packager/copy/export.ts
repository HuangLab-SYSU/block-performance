...
export { rpc_copy } from "./rpc/client.js";
export { Input as CopyInput, Output as CopyOutput } from "./type.js";
export { make_input as make_copy_input, make_output_ok as make_copy_output_ok } from "./tool/index.js";
...
export async function copy<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("packager", "copy");
