...
import { dependency_list_version_check as target } from "../export.js";
...
export async function handle_rpc_dependency_list_version_check<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_dependency_list_version_check");
