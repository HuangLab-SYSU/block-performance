...
export async function rpc_dependency_list_version_check<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_dependency_list_version_check");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/package-json/dependency-list-version-check`,
                data: input
            },
            {
