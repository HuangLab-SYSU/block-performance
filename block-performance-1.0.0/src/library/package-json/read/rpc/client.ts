...
export async function rpc_read<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_read");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/package-json/read`,
                data: input
            },
            {
