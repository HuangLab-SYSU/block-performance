...
export { rpc_read } from "./rpc/client.js";
export { Input as ReadInput, Output as ReadOutput } from "./type.js";
export { make_input as make_read_input, make_output_ok as make_read_output_ok } from "./tool/index.js";
...
export async function read<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("package-json", "read");
    try {
