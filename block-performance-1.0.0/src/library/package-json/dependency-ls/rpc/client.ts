...
export async function rpc_dependency_ls<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_dependency_ls");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/package-json/dependency-ls`,
                data: input
            },
            {
