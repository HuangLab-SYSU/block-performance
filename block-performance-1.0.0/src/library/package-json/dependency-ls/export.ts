...
export { rpc_dependency_ls } from "./rpc/client.js";
export { Input as DependencyLsInput, Output as DependencyLsOutput } from "./type.js";
export { make_input as make_dependency_ls_input, make_output_ok as make_dependency_ls_output_ok } from "./tool/index.js";
...
export async function dependency_ls<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("package-json", "dependency-ls");
