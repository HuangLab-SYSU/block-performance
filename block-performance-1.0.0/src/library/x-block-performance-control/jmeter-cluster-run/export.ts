...
export { rpc_jmeter_cluster_run } from "./rpc/client.js";
export { Input as JmeterClusterRunInput, Output as JmeterClusterRunOutput } from "./type.js";
export { make_input as make_jmeter_cluster_run_input, make_output_ok as make_jmeter_cluster_run_output_ok } from "./tool/index.js";
...
export async function jmeter_cluster_run<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-block-performance-control", "jmeter-cluster-run");
