...
import { target_cluster_create as target } from "../export.js";
...
export async function handle_rpc_target_cluster_create<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_target_cluster_create");
