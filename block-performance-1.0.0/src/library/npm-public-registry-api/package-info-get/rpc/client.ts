...
export async function rpc_package_info_get<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_package_info_get");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/npm-public-registry-api/package-info-get`,
                data: input
            },
            {
