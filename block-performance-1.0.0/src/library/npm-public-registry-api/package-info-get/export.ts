...
export { rpc_package_info_get } from "./rpc/client.js";
export { Input as PackageInfoGetInput, Output as PackageInfoGetOutput } from "./type.js";
export { make_input as make_package_info_get_input, make_output_ok as make_package_info_get_output_ok } from "./tool/index.js";
...
export async function package_info_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("npm-public-registry-api", "package-info-get");
