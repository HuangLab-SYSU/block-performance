...
export { rpc_credential_set } from "./rpc/client.js";
export { Input as CredentialSetInput, Output as CredentialSetOutput } from "./type.js";
export { make_input as make_credential_set_input, make_output_ok as make_credential_set_output_ok } from "./tool/index.js";
...
export async function credential_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-credential", "credential-set");
