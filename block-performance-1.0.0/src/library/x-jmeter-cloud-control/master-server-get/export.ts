...
export { make_input as make_master_server_get_input, make_output_ok as make_master_server_get_output_ok } from "./tool/index.js";
...
export async function master_server_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-control", "master-server-get");
