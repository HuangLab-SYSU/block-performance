...
export { rpc_master_server_config } from "./rpc/client.js";
export { Input as MasterServerConfigInput, Output as MasterServerConfigOutput } from "./type.js";
export { make_input as make_master_server_config_input, make_output_ok as make_master_server_config_output_ok } from "./tool/index.js";
...
export async function master_server_config<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-control", "master-server-config");
