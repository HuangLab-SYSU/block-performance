...
export { rpc_target_server_remove } from "./rpc/client.js";
export { Input as TargetServerRemoveInput, Output as TargetServerRemoveOutput } from "./type.js";
export { make_input as make_target_server_remove_input, make_output_ok as make_target_server_remove_output_ok } from "./tool/index.js";
...
export async function target_server_remove<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-control", "target-server-remove");
