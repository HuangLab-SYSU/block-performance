...
import { master_server_config_slave_address_list_update as target_fun } from "./export.js";
import { rpc_master_server_config_slave_address_list_update as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { master_server_id: string }) => R; fail: (err: Error) => R }): Promise<R> {
    const log = plog.sub("make_input_from_prompts");
    try {
        var v: { master_server_id: string } = {
