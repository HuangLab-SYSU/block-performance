...
export { make_input as make_slave_server_get_input, make_output_ok as make_slave_server_get_output_ok } from "./tool/index.js";
...
export async function slave_server_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-control", "slave-server-get");
