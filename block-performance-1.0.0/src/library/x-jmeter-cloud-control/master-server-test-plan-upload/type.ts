...
export function _copy_output_ok(v: any): OutputOk {
    if (typeof v === "object" && v !== null) {
        const obj = {
            remote_test_plan_file_path: copy_remote_test_plan_file_path(v.remote_test_plan_file_path)
        };
        return obj;
    } else {
        return { remote_test_plan_file_path: "" };
    }

    function copy_remote_test_plan_file_path(v: any): string {
