...
export { rpc_master_server_config_auth_file_upload } from "./rpc/client.js";
export { Input as MasterServerConfigAuthFileUploadInput, Output as MasterServerConfigAuthFileUploadOutput } from "./type.js";
export {
    make_input as make_master_server_config_auth_file_upload_input,
    make_output_ok as make_master_server_config_auth_file_upload_output_ok
} from "./tool/index.js";
