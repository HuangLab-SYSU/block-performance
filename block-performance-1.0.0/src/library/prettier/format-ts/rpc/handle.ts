...
import { format_ts as target } from "../export.js";
...
export async function handle_rpc_format_ts<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_format_ts");
