...
export { rpc_format_ts } from "./rpc/client.js";
export { Input as FormatTsInput, Output as FormatTsOutput } from "./type.js";
export { make_input as make_format_ts_input, make_output_ok as make_format_ts_output_ok } from "./tool/index.js";
...
export async function format_ts<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("prettier", "format-ts");
