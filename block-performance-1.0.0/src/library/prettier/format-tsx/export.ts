...
export { rpc_format_tsx } from "./rpc/client.js";
export { Input as FormatTsxInput, Output as FormatTsxOutput } from "./type.js";
export { make_input as make_format_tsx_input, make_output_ok as make_format_tsx_output_ok } from "./tool/index.js";
...
export async function format_tsx<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("prettier", "format-tsx");
