...
export async function rpc_format_file<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_format_file");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/prettier/format-file`,
                data: input
            },
            {
