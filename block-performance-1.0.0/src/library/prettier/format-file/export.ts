...
export { rpc_format_file } from "./rpc/client.js";
export { Input as FormatFileInput, Output as FormatFileOutput } from "./type.js";
export { make_input as make_format_file_input, make_output_ok as make_format_file_output_ok } from "./tool/index.js";
...
export async function format_file<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("prettier", "format-file");
