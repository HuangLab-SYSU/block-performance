...
export { rpc_instance_reboot } from "./rpc/client.js";
export { Input as InstanceRebootInput, Output as InstanceRebootOutput } from "./type.js";
export { make_input as make_instance_reboot_input, make_output_ok as make_instance_reboot_output_ok } from "./tool/index.js";
...
export async function instance_reboot<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("aws-lightsail", "instance-reboot");
