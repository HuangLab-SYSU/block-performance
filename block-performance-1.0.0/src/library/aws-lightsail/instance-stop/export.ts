...
export { rpc_instance_stop } from "./rpc/client.js";
export { Input as InstanceStopInput, Output as InstanceStopOutput } from "./type.js";
export { make_input as make_instance_stop_input, make_output_ok as make_instance_stop_output_ok } from "./tool/index.js";
...
export async function instance_stop<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("aws-lightsail", "instance-stop");
