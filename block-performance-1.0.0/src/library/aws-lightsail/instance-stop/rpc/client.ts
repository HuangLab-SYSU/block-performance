...
export async function rpc_instance_stop<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_instance_stop");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/aws-lightsail/instance-stop`,
                data: input
            },
            {
