...
import { keypair_delete as target } from "../export.js";
...
export async function handle_rpc_keypair_delete<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_keypair_delete");
