...
export async function rpc_instance_port_states_get<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_instance_port_states_get");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/aws-lightsail/instance-port-states-get`,
                data: input
            },
            {
