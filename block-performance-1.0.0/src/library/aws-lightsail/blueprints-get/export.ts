...
export { rpc_blueprints_get } from "./rpc/client.js";
export { Input as BlueprintsGetInput, Output as BlueprintsGetOutput } from "./type.js";
export { make_input as make_blueprints_get_input, make_output_ok as make_blueprints_get_output_ok } from "./tool/index.js";
...
export async function blueprints_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("aws-lightsail", "blueprints-get");
