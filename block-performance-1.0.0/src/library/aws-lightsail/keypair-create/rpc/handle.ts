...
import { keypair_create as target } from "../export.js";
...
export async function handle_rpc_keypair_create<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_keypair_create");
