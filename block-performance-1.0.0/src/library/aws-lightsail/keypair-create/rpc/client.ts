...
export async function rpc_keypair_create<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_keypair_create");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/aws-lightsail/keypair-create`,
                data: input
            },
            {
