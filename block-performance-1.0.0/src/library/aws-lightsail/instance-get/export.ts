...
export { rpc_instance_get } from "./rpc/client.js";
export { Input as InstanceGetInput, Output as InstanceGetOutput } from "./type.js";
export { make_input as make_instance_get_input, make_output_ok as make_instance_get_output_ok } from "./tool/index.js";
...
export async function instance_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("aws-lightsail", "instance-get");
