...
export async function rpc_keypair_default_download<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_keypair_default_download");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/aws-lightsail/keypair-default-download`,
                data: input
            },
            {
