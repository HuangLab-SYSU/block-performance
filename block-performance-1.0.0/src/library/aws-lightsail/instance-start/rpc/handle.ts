...
import { instance_start as target } from "../export.js";
...
export async function handle_rpc_instance_start<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_instance_start");
