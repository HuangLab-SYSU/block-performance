...
export async function rpc_instance_public_ports_put<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_instance_public_ports_put");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/aws-lightsail/instance-public-ports-put`,
                data: input
            },
            {
