...
import { instance_public_ports_put as target } from "../export.js";
...
export async function handle_rpc_instance_public_ports_put<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_instance_public_ports_put");
