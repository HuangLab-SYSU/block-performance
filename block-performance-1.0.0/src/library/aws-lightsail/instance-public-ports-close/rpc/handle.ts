...
import { instance_public_ports_close as target } from "../export.js";
...
export async function handle_rpc_instance_public_ports_close<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_instance_public_ports_close");
