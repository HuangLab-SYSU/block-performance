...
export { rpc_keypairs_get } from "./rpc/client.js";
export { Input as KeypairsGetInput, Output as KeypairsGetOutput } from "./type.js";
export { make_input as make_keypairs_get_input, make_output_ok as make_keypairs_get_output_ok } from "./tool/index.js";
...
export async function keypairs_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("aws-lightsail", "keypairs-get");
