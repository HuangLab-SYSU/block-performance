...
export { rpc_ssh_install_nodejs } from "./rpc/client.js";
export { Input as SshInstallNodejsInput, Output as SshInstallNodejsOutput } from "./type.js";
export { make_input as make_ssh_install_nodejs_input, make_output_ok as make_ssh_install_nodejs_output_ok } from "./tool/index.js";
...
export async function ssh_install_nodejs<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-install-nodejs");
