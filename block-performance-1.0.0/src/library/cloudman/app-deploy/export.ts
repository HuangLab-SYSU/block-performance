...
export { rpc_app_deploy } from "./rpc/client.js";
export { Input as AppDeployInput, Output as AppDeployOutput } from "./type.js";
export { make_input as make_app_deploy_input, make_output_ok as make_app_deploy_output_ok } from "./tool/index.js";
...
export async function app_deploy<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "app-deploy");
    try {
