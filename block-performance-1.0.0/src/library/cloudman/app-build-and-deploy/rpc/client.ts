...
export async function rpc_app_build_and_deploy<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_app_build_and_deploy");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/cloudman/app-build-and-deploy`,
                data: input
            },
            {
