...
import { app_build_and_deploy as target } from "../export.js";
...
export async function handle_rpc_app_build_and_deploy<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_app_build_and_deploy");
