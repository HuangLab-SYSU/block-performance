...
export { rpc_ssh_exec_script } from "./rpc/client.js";
export { Input as SshExecScriptInput, Output as SshExecScriptOutput } from "./type.js";
export { make_input as make_ssh_exec_script_input, make_output_ok as make_ssh_exec_script_output_ok } from "./tool/index.js";
...
export async function ssh_exec_script<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-exec-script");
