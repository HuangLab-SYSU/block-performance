...
export function check_input<R>(plog: Logger, v: any, cb: { ok: () => R; fail: (err: Error) => R }): R {
    ...
    try {
        ...
        Object.keys(v).forEach((field) => {
            ...
            if (field === "noninteractive") return;
        ...
        if (v.noninteractive !== undefined) {
            log.println("v.noninteractive must be boolean");
            if (typeof v.noninteractive !== "boolean") {
                throw new Error("v.noninteractive is not boolean");
            }
        }
