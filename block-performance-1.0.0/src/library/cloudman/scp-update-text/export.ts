...
export { rpc_scp_update_text } from "./rpc/client.js";
export { Input as ScpUpdateTextInput, Output as ScpUpdateTextOutput } from "./type.js";
export { make_input as make_scp_update_text_input, make_output_ok as make_scp_update_text_output_ok } from "./tool/index.js";
...
export async function scp_update_text<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "scp-update-text");
