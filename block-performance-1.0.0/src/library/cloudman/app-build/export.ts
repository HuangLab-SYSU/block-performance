...
export { rpc_app_build } from "./rpc/client.js";
export { Input as AppBuildInput, Output as AppBuildOutput } from "./type.js";
export { make_input as make_app_build_input, make_output_ok as make_app_build_output_ok } from "./tool/index.js";
...
export async function app_build<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "app-build");
