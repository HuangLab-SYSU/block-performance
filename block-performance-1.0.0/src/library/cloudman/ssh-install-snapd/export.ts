...
export { rpc_ssh_install_snapd } from "./rpc/client.js";
export { Input as SshInstallSnapdInput, Output as SshInstallSnapdOutput } from "./type.js";
export { make_input as make_ssh_install_snapd_input, make_output_ok as make_ssh_install_snapd_output_ok } from "./tool/index.js";
...
export async function ssh_install_snapd<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-install-snapd");
