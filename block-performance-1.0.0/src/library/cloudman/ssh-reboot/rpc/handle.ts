...
import { ssh_reboot as target } from "../export.js";
...
export async function handle_rpc_ssh_reboot<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_ssh_reboot");
