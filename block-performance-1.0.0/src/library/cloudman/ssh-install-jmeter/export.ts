...
export { rpc_ssh_install_jmeter } from "./rpc/client.js";
export { Input as SshInstallJmeterInput, Output as SshInstallJmeterOutput } from "./type.js";
export { make_input as make_ssh_install_jmeter_input, make_output_ok as make_ssh_install_jmeter_output_ok } from "./tool/index.js";
...
export async function ssh_install_jmeter<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-install-jmeter");
