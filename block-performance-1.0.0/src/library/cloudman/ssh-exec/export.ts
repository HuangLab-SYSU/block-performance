...
export { rpc_ssh_exec } from "./rpc/client.js";
export { Input as SshExecInput, Output as SshExecOutput } from "./type.js";
export { make_input as make_ssh_exec_input, make_output_ok as make_ssh_exec_output_ok } from "./tool/index.js";
...
export async function ssh_exec<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-exec");
    try {
