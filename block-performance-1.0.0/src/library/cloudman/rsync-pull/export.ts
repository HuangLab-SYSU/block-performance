...
export { rpc_rsync_pull } from "./rpc/client.js";
export { Input as RsyncPullInput, Output as RsyncPullOutput } from "./type.js";
export { make_input as make_rsync_pull_input, make_output_ok as make_rsync_pull_output_ok } from "./tool/index.js";
...
export async function rsync_pull<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "rsync-pull");
