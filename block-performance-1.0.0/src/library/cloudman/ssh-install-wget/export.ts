...
export { rpc_ssh_install_wget } from "./rpc/client.js";
export { Input as SshInstallWgetInput, Output as SshInstallWgetOutput } from "./type.js";
export { make_input as make_ssh_install_wget_input, make_output_ok as make_ssh_install_wget_output_ok } from "./tool/index.js";
...
export async function ssh_install_wget<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-install-wget");
