...
export { rpc_scp_download } from "./rpc/client.js";
export { Input as ScpDownloadInput, Output as ScpDownloadOutput } from "./type.js";
export { make_input as make_scp_download_input, make_output_ok as make_scp_download_output_ok } from "./tool/index.js";
...
export async function scp_download<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "scp-download");
