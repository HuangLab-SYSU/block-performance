...
import { scp_upload as target } from "../export.js";
...
export async function handle_rpc_scp_upload<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_scp_upload");
