...
export { rpc_scp_upload } from "./rpc/client.js";
export { Input as ScpUploadInput, Output as ScpUploadOutput } from "./type.js";
export { make_input as make_scp_upload_input, make_output_ok as make_scp_upload_output_ok } from "./tool/index.js";
...
export async function scp_upload<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "scp-upload");
