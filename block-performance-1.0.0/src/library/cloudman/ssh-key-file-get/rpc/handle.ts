...
import { ssh_key_file_get as target } from "../export.js";
...
export async function handle_rpc_ssh_key_file_get<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_ssh_key_file_get");
