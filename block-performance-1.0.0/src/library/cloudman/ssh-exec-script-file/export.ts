...
export { rpc_ssh_exec_script_file } from "./rpc/client.js";
export { Input as SshExecScriptFileInput, Output as SshExecScriptFileOutput } from "./type.js";
export { make_input as make_ssh_exec_script_file_input, make_output_ok as make_ssh_exec_script_file_output_ok } from "./tool/index.js";
...
export async function ssh_exec_script_file<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "ssh-exec-script-file");
