...
import { ssh_install_python as target } from "../export.js";
...
export async function handle_rpc_ssh_install_python<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_ssh_install_python");
