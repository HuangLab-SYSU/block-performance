...
export { rpc_rsync_push } from "./rpc/client.js";
export { Input as RsyncPushInput, Output as RsyncPushOutput } from "./type.js";
export { make_input as make_rsync_push_input, make_output_ok as make_rsync_push_output_ok } from "./tool/index.js";
...
export async function rsync_push<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("cloudman", "rsync-push");
