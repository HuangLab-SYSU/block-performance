...
import { rsync_push as target } from "../export.js";
...
export async function handle_rpc_rsync_push<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_rsync_push");
