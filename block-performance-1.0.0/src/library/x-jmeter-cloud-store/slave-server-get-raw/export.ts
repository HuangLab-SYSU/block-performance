...
export { rpc_slave_server_get_raw } from "./rpc/client.js";
export { Input as SlaveServerGetRawInput, Output as SlaveServerGetRawOutput } from "./type.js";
export {
    make_input as make_slave_server_get_raw_input,
    make_output_none as make_slave_server_get_raw_output_none,
    make_output_ok as make_slave_server_get_raw_output_ok
} from "./tool/index.js";
