...
export async function core<R>(log: Logger, input: Input & { global_filter_fun?: (item: store.Credential) => boolean }, cb: Callback<R>): Promise<R> {
...
function apply_pagination(plog: Logger, input: Input, list: store.Credential[]): store.Credential[] {
