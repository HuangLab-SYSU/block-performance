...
export { rpc_credential_ls } from "./rpc/client.js";
export { Input as CredentialLsInput, Output as CredentialLsOutput } from "./type.js";
export {
    make_input as make_credential_ls_input,
    make_output_empty as make_credential_ls_output_empty,
    make_output_ok as make_credential_ls_output_ok
} from "./tool/index.js";
...
export async function credential_ls<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "credential-ls");
