...
export { rpc_slave_server_upgrade } from "./rpc/client.js";
export { Input as SlaveServerUpgradeInput, Output as SlaveServerUpgradeOutput } from "./type.js";
export { make_input as make_slave_server_upgrade_input, make_output_ok as make_slave_server_upgrade_output_ok } from "./tool/index.js";
...
export async function slave_server_upgrade<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "slave-server-upgrade");
