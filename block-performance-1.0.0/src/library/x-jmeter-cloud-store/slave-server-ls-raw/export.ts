...
export { rpc_slave_server_ls_raw } from "./rpc/client.js";
export { Input as SlaveServerLsRawInput, Output as SlaveServerLsRawOutput } from "./type.js";
export {
    make_input as make_slave_server_ls_raw_input,
    make_output_empty as make_slave_server_ls_raw_output_empty,
    make_output_ok as make_slave_server_ls_raw_output_ok
} from "./tool/index.js";
...
export async function slave_server_ls_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "slave-server-ls-raw");
