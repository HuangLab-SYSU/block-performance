...
export { rpc_credential_upgrade } from "./rpc/client.js";
export { Input as CredentialUpgradeInput, Output as CredentialUpgradeOutput } from "./type.js";
export { make_input as make_credential_upgrade_input, make_output_ok as make_credential_upgrade_output_ok } from "./tool/index.js";
...
export async function credential_upgrade<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "credential-upgrade");
