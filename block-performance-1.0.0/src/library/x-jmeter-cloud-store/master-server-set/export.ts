...
export { rpc_master_server_set } from "./rpc/client.js";
export { Input as MasterServerSetInput, Output as MasterServerSetOutput } from "./type.js";
export { make_input as make_master_server_set_input, make_output_ok as make_master_server_set_output_ok } from "./tool/index.js";
...
export async function master_server_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "master-server-set");
