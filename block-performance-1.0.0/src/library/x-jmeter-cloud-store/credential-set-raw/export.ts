...
export { rpc_credential_set_raw } from "./rpc/client.js";
export { Input as CredentialSetRawInput, Output as CredentialSetRawOutput } from "./type.js";
export { make_input as make_credential_set_raw_input, make_output_ok as make_credential_set_raw_output_ok } from "./tool/index.js";
...
export async function credential_set_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "credential-set-raw");
