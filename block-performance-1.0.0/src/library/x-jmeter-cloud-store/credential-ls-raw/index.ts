...
import { credential_ls_raw as target_fun } from "./export.js";
import { rpc_credential_ls_raw as rpc_target_fun } from "./rpc/client.js";
            ...
            async function input_item<R>(
                ...
                try {
                    var v: {
                        ...
                        aws_lightsail: await skip_or_input("aws_lightsail", () =>
                            input_aws_lightsail(log.sub("aws_lightsail"), {
                                ok: (v) => v,
                                fail: (err) => {
                                    throw err;
                                }
                ...
                async function input_aws_lightsail<R>(
                    plog: Logger,
                    cb: {
                        ok: (v: { access_key_id?: { order: "ascending" | "descending" }; secret_access_key?: { order: "ascending" | "descending" } }) => R;
                        fail: (err: Error) => R;
                    }
                ): Promise<R> {
                    const log = plog.sub("input_aws_lightsail");
                    try {
                        var v: { access_key_id?: { order: "ascending" | "descending" }; secret_access_key?: { order: "ascending" | "descending" } } = {
                            access_key_id: await skip_or_input("access_key_id", () =>
                                input_access_key_id(log.sub("access_key_id"), {
                                    ok: (v) => v,
                                    fail: (err) => {
                                        throw err;
                                    }
                            ...
                            secret_access_key: await skip_or_input("secret_access_key", () =>
                                input_secret_access_key(log.sub("secret_access_key"), {
                                    ok: (v) => v,
                                    fail: (err) => {
                                        throw err;
                                    }
                    ...
                    async function input_access_key_id<R>(
                        plog: Logger,
                        cb: { ok: (v: { order: "ascending" | "descending" }) => R; fail: (err: Error) => R }
                    ): Promise<R> {
                    ...
                    async function input_secret_access_key<R>(
                        plog: Logger,
                        cb: { ok: (v: { order: "ascending" | "descending" }) => R; fail: (err: Error) => R }
                    ): Promise<R> {
