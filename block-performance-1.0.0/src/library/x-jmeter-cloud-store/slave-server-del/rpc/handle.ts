...
import { slave_server_del as target } from "../export.js";
...
export async function handle_rpc_slave_server_del<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_slave_server_del");
