...
export { rpc_slave_server_del } from "./rpc/client.js";
export { Input as SlaveServerDelInput, Output as SlaveServerDelOutput } from "./type.js";
export { make_input as make_slave_server_del_input, make_output_ok as make_slave_server_del_output_ok } from "./tool/index.js";
...
export async function slave_server_del<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "slave-server-del");
