...
export { rpc_master_server_ls } from "./rpc/client.js";
export { Input as MasterServerLsInput, Output as MasterServerLsOutput } from "./type.js";
export {
    make_input as make_master_server_ls_input,
    make_output_empty as make_master_server_ls_output_empty,
    make_output_ok as make_master_server_ls_output_ok
} from "./tool/index.js";
...
export async function master_server_ls<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "master-server-ls");
