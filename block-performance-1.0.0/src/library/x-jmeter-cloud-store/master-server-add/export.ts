...
export { rpc_master_server_add } from "./rpc/client.js";
export { Input as MasterServerAddInput, Output as MasterServerAddOutput } from "./type.js";
export { make_input as make_master_server_add_input, make_output_ok as make_master_server_add_output_ok } from "./tool/index.js";
...
export async function master_server_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-jmeter-cloud-store", "master-server-add");
