...
import { target_server_upgrade as target } from "../export.js";
...
export async function handle_rpc_target_server_upgrade<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_target_server_upgrade");
