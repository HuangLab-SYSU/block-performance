...
export { rpc_collection_item_get } from "./rpc/client.js";
export { Input as CollectionItemGetInput, Output as CollectionItemGetOutput } from "./type.js";
export { make_input as make_collection_item_get_input, make_output_ok as make_collection_item_get_output_ok } from "./tool/index.js";
...
export async function collection_item_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("storage-simple-coll-api-disk", "collection-item-get");
