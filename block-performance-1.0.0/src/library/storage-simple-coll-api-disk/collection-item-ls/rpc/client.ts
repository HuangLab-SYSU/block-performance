...
export async function rpc_collection_item_ls<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_collection_item_ls");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/storage-simple-coll-api-disk/collection-item-ls`,
                data: input
            },
            {
