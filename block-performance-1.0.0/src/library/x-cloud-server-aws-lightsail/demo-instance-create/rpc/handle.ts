...
import { demo_instance_create as target } from "../export.js";
...
export async function handle_rpc_demo_instance_create<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_demo_instance_create");
