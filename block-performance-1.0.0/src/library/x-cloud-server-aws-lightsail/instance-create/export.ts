...
export { rpc_instance_create } from "./rpc/client.js";
export { Input as InstanceCreateInput, Output as InstanceCreateOutput } from "./type.js";
export { make_input as make_instance_create_input, make_output_ok as make_instance_create_output_ok } from "./tool/index.js";
...
export async function instance_create<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-aws-lightsail", "instance-create");
