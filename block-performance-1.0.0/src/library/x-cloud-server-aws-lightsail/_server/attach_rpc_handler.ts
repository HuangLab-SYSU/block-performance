...
import { handle_rpc_demo_instance_create } from "../demo-instance-create/rpc/handle.js";
...
export function attach_rpc_handler(plog: Logger, opt: { exp_app: express.Express }) {
    ...
    exp_app.post("/library/x-cloud-server-aws-lightsail/demo-instance-create", (req, res) => {
        const input = req.body;
        const req_log = log.sub("post.library.x-cloud-server-aws-lightsail.demo-instance-create");
        handle_rpc_demo_instance_create(req_log, input, {
            invalid_input: (err) => {
                // bad request
                req_log.error(err);
                res.status(400);
    ...
    exp_app.post("/library/x-cloud-server-aws-lightsail/instance-create", (req, res) => {
        const input = req.body;
    ...
    exp_app.post("/library/x-cloud-server-aws-lightsail/instance-remove", (req, res) => {
        const input = req.body;
