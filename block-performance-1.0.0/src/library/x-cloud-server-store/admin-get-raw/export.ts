...
export { rpc_admin_get_raw } from "./rpc/client.js";
export { Input as AdminGetRawInput, Output as AdminGetRawOutput } from "./type.js";
export {
    make_input as make_admin_get_raw_input,
    make_output_none as make_admin_get_raw_output_none,
    make_output_ok as make_admin_get_raw_output_ok
} from "./tool/index.js";
...
export async function admin_get_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-get-raw");
