...
export { rpc_admin_set } from "./rpc/client.js";
export { Input as AdminSetInput, Output as AdminSetOutput } from "./type.js";
export { make_input as make_admin_set_input, make_output_ok as make_admin_set_output_ok } from "./tool/index.js";
...
export async function admin_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-set");
    try {
