...
export { rpc_admin_upgrade } from "./rpc/client.js";
export { Input as AdminUpgradeInput, Output as AdminUpgradeOutput } from "./type.js";
export { make_input as make_admin_upgrade_input, make_output_ok as make_admin_upgrade_output_ok } from "./tool/index.js";
...
export async function admin_upgrade<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-upgrade");
