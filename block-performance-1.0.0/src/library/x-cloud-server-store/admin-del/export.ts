...
export { rpc_admin_del } from "./rpc/client.js";
export { Input as AdminDelInput, Output as AdminDelOutput } from "./type.js";
export { make_input as make_admin_del_input, make_output_ok as make_admin_del_output_ok } from "./tool/index.js";
...
export async function admin_del<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-del");
