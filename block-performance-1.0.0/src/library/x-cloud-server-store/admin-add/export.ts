...
export { rpc_admin_add } from "./rpc/client.js";
export { Input as AdminAddInput, Output as AdminAddOutput } from "./type.js";
export { make_input as make_admin_add_input, make_output_ok as make_admin_add_output_ok } from "./tool/index.js";
...
export async function admin_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-add");
    try {
