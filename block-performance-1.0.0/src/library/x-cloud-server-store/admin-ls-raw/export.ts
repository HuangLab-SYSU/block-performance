...
export { rpc_admin_ls_raw } from "./rpc/client.js";
export { Input as AdminLsRawInput, Output as AdminLsRawOutput } from "./type.js";
export {
    make_input as make_admin_ls_raw_input,
    make_output_empty as make_admin_ls_raw_output_empty,
    make_output_ok as make_admin_ls_raw_output_ok
} from "./tool/index.js";
...
export async function admin_ls_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-cloud-server-store", "admin-ls-raw");
