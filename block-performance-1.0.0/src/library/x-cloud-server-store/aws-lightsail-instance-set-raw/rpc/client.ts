...
export async function rpc_aws_lightsail_instance_set_raw<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_aws_lightsail_instance_set_raw");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/x-cloud-server-store/aws-lightsail-instance-set-raw`,
                data: input
            },
            {
