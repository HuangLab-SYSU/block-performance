...
function make_root_sort_fun(
    ...
    [
        ...
        sort_option.update_time
            ...
            : undefined,
        sort_option.region
            ? make_field_sort_fun_region(log, {
                  sort_option: sort_option.region,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.region : undefined;
                  }
              })
            : undefined,
        sort_option.availability_zone
            ? make_field_sort_fun_availability_zone(log, {
                  sort_option: sort_option.availability_zone,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.availability_zone : undefined;
                  }
              })
            : undefined,
        sort_option.instance_name
            ? make_field_sort_fun_instance_name(log, {
                  sort_option: sort_option.instance_name,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.instance_name : undefined;
                  }
              })
            : undefined,
        sort_option.blueprint_id
            ? make_field_sort_fun_blueprint_id(log, {
                  sort_option: sort_option.blueprint_id,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.blueprint_id : undefined;
                  }
              })
            : undefined,
        sort_option.bundle_id
            ? make_field_sort_fun_bundle_id(log, {
                  sort_option: sort_option.bundle_id,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.bundle_id : undefined;
                  }
              })
            : undefined,
        sort_option.ssh_username
            ? make_field_sort_fun_ssh_username(log, {
                  sort_option: sort_option.ssh_username,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.ssh_username : undefined;
                  }
              })
            : undefined,
        sort_option.address_ipv4
            ? make_field_sort_fun_address_ipv4(log, {
                  sort_option: sort_option.address_ipv4,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.address_ipv4 : undefined;
                  }
              })
            : undefined,
        sort_option.address_ipv6
            ? make_field_sort_fun_address_ipv6(log, {
                  sort_option: sort_option.address_ipv6,
                  get_value: (data) => {
                      const v = get_value(data);
                      return v ? v.address_ipv6 : undefined;
                  }
              })
            : undefined
    ].forEach((item) => {
    ...
    function make_field_sort_fun_region(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_region");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_availability_zone(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_availability_zone");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_instance_name(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_instance_name");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_blueprint_id(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_blueprint_id");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_bundle_id(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_bundle_id");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_ssh_username(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_ssh_username");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_address_ipv4(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_address_ipv4");
        const { sort_option, get_value } = opt;
    ...
    function make_field_sort_fun_address_ipv6(
        plog: Logger,
        opt: {
            sort_option: { order: "ascending" | "descending" };
            get_value: (item: Data) => string | undefined; // undefined for optional field
        ...
        const log = plog.sub("make_field_sort_fun_address_ipv6");
        const { sort_option, get_value } = opt;
