...
export { rpc_key_disabled_set } from "./rpc/client.js";
export { Input as KeyDisabledSetInput, Output as KeyDisabledSetOutput } from "./type.js";
export { make_input as make_key_disabled_set_input, make_output_ok as make_key_disabled_set_output_ok } from "./tool/index.js";
...
export async function key_disabled_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-control", "key-disabled-set");
