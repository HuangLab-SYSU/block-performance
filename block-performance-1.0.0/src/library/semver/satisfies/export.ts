...
export { rpc_satisfies } from "./rpc/client.js";
export { Input as SatisfiesInput, Output as SatisfiesOutput } from "./type.js";
export { make_input as make_satisfies_input, make_output_ok as make_satisfies_output_ok } from "./tool/index.js";
...
export async function satisfies<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("semver", "satisfies");
