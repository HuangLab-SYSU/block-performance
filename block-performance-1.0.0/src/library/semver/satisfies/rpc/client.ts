...
export async function rpc_satisfies<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_satisfies");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/semver/satisfies`,
                data: input
            },
            {
