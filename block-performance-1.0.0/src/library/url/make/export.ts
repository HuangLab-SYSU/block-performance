...
export { rpc_make } from "./rpc/client.js";
export { Input as MakeInput, Output as MakeOutput } from "./type.js";
export { make_input as make_make_input, make_output_ok as make_make_output_ok } from "./tool/index.js";
...
export async function make<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("url", "make");
