...
export async function rpc_search_params_merge<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_search_params_merge");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/url/search-params-merge`,
                data: input
            },
            {
