...
export { rpc_search_params_merge } from "./rpc/client.js";
export { Input as SearchParamsMergeInput, Output as SearchParamsMergeOutput } from "./type.js";
export { make_input as make_search_params_merge_input, make_output_ok as make_search_params_merge_output_ok } from "./tool/index.js";
...
export async function search_params_merge<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("url", "search-params-merge");
