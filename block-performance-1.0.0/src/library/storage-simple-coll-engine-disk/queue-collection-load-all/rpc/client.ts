...
export async function rpc_queue_collection_load_all<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_queue_collection_load_all");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/storage-simple-coll-engine-disk/queue-collection-load-all`,
                data: input
            },
            {
