...
export { rpc_key_add_raw } from "./rpc/client.js";
export { Input as KeyAddRawInput, Output as KeyAddRawOutput } from "./type.js";
export { make_input as make_key_add_raw_input, make_output_ok as make_key_add_raw_output_ok } from "./tool/index.js";
...
export async function key_add_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-add-raw");
