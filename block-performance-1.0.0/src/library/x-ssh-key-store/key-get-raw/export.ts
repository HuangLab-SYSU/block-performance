...
export { rpc_key_get_raw } from "./rpc/client.js";
export { Input as KeyGetRawInput, Output as KeyGetRawOutput } from "./type.js";
export {
    make_input as make_key_get_raw_input,
    make_output_none as make_key_get_raw_output_none,
    make_output_ok as make_key_get_raw_output_ok
} from "./tool/index.js";
...
export async function key_get_raw<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-get-raw");
