...
import { admin_add as target } from "../export.js";
...
export async function handle_rpc_admin_add<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_admin_add");
