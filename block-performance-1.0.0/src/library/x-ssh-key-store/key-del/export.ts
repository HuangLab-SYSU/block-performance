...
export { rpc_key_del } from "./rpc/client.js";
export { Input as KeyDelInput, Output as KeyDelOutput } from "./type.js";
export { make_input as make_key_del_input, make_output_ok as make_key_del_output_ok } from "./tool/index.js";
...
export async function key_del<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-del");
    try {
