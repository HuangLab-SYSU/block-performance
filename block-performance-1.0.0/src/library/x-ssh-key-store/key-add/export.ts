...
export { rpc_key_add } from "./rpc/client.js";
export { Input as KeyAddInput, Output as KeyAddOutput } from "./type.js";
export { make_input as make_key_add_input, make_output_ok as make_key_add_output_ok } from "./tool/index.js";
...
export async function key_add<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-add");
