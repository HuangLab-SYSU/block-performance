...
export { rpc_key_get } from "./rpc/client.js";
export { Input as KeyGetInput, Output as KeyGetOutput } from "./type.js";
export { make_input as make_key_get_input, make_output_none as make_key_get_output_none, make_output_ok as make_key_get_output_ok } from "./tool/index.js";
...
export async function key_get<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-get");
