...
export { rpc_key_set } from "./rpc/client.js";
export { Input as KeySetInput, Output as KeySetOutput } from "./type.js";
export { make_input as make_key_set_input, make_output_ok as make_key_set_output_ok } from "./tool/index.js";
...
export async function key_set<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("x-ssh-key-store", "key-set");
    try {
