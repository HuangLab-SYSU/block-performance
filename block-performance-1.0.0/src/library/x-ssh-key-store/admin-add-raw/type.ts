...
export function check_input<R>(plog: Logger, v: any, cb: { ok: () => R; fail: (err: Error) => R }): R {
    ...
    try {
        ...
        log.println("v.admin.create_time must be string");
        if (typeof v.admin.create_time !== "string") {
            throw new Error("v.admin.create_time is not string");
        }

        if (v.admin.create_time !== "" && Number.isNaN(Date.parse(v.admin.create_time))) {
            throw new Error("v.admin.create_time is not a valid datetime string");
        }

        log.println("v.admin.update_time must be string");
        if (typeof v.admin.update_time !== "string") {
            throw new Error("v.admin.update_time is not string");
        }

        if (v.admin.update_time !== "" && Number.isNaN(Date.parse(v.admin.update_time))) {
            throw new Error("v.admin.update_time is not a valid datetime string");
        }
