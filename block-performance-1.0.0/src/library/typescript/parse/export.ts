...
export { rpc_parse } from "./rpc/client.js";
export { Input as ParseInput, Output as ParseOutput } from "./type.js";
export { make_input as make_parse_input, make_output_ok as make_parse_output_ok } from "./tool/index.js";
...
export async function parse<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "parse");
    try {
