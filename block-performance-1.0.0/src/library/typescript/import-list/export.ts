...
export { rpc_import_list } from "./rpc/client.js";
export { Input as ImportListInput, Output as ImportListOutput } from "./type.js";
export {
    make_input as make_import_list_input,
    make_output_empty as make_import_list_output_empty,
    make_output_ok as make_import_list_output_ok
} from "./tool/index.js";
...
export async function import_list<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "import-list");
