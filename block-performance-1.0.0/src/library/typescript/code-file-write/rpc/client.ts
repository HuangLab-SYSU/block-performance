...
export async function rpc_code_file_write<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_code_file_write");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/typescript/code-file-write`,
                data: input
            },
            {
