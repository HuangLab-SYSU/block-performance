...
export { rpc_code_file_write } from "./rpc/client.js";
export { Input as CodeFileWriteInput, Output as CodeFileWriteOutput } from "./type.js";
export { make_input as make_code_file_write_input, make_output_ok as make_code_file_write_output_ok } from "./tool/index.js";
...
export async function code_file_write<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "code-file-write");
