...
export { rpc_code_file_rewrite } from "./rpc/client.js";
export { Input as CodeFileRewriteInput, Output as CodeFileRewriteOutput } from "./type.js";
export { make_input as make_code_file_rewrite_input, make_output_ok as make_code_file_rewrite_output_ok } from "./tool/index.js";
...
export async function code_file_rewrite<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "code-file-rewrite");
