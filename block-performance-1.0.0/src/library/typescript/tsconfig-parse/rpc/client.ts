...
export async function rpc_tsconfig_parse<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_tsconfig_parse");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/typescript/tsconfig-parse`,
                data: input
            },
            {
