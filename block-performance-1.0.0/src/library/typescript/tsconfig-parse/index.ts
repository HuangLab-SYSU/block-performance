...
import { tsconfig_parse as target_fun } from "./export.js";
import { rpc_tsconfig_parse as rpc_target_fun } from "./rpc/client.js";
...
async function make_input_from_prompts<R>(plog: Logger, cb: { ok: (v: { file: string }) => R; fail: (err: Error) => R }): Promise<R> {
