...
export { rpc_tsconfig_parse_text } from "./rpc/client.js";
export { Input as TsconfigParseTextInput, Output as TsconfigParseTextOutput } from "./type.js";
export { make_input as make_tsconfig_parse_text_input, make_output_ok as make_tsconfig_parse_text_output_ok } from "./tool/index.js";
...
export async function tsconfig_parse_text<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "tsconfig-parse-text");
