...
export { rpc_code_file_read } from "./rpc/client.js";
export { Input as CodeFileReadInput, Output as CodeFileReadOutput } from "./type.js";
export { make_input as make_code_file_read_input, make_output_ok as make_code_file_read_output_ok } from "./tool/index.js";
...
export async function code_file_read<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("typescript", "code-file-read");
