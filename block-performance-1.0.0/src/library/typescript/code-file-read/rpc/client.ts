...
export async function rpc_code_file_read<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_code_file_read");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/typescript/code-file-read`,
                data: input
            },
            {
