...
export async function rpc_print_import<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_print_import");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/typescript/print-import`,
                data: input
            },
            {
