...
export async function rpc_plugin_list<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_plugin_list");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/tailwind/plugin-list`,
                data: input
            },
            {
