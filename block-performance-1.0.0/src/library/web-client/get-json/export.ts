...
export { rpc_get_json } from "./rpc/client.js";
export { Input as GetJsonInput, Output as GetJsonOutput } from "./type.js";
export { make_input as make_get_json_input, make_output_ok as make_get_json_output_ok } from "./tool/index.js";
...
export async function get_json<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("web-client", "get-json");
