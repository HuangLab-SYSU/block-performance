...
export async function rpc_get_json<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_get_json");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/web-client/get-json`,
                data: input
            },
            {
