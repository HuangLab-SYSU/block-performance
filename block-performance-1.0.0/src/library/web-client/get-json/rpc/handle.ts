...
import { get_json as target } from "../export.js";
...
export async function handle_rpc_get_json<R>(plog: Logger, input: any, cb: Callback<R>): Promise<R> {
    const log = plog.sub("handle_rpc_get_json");
