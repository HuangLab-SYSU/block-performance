...
export { rpc_head } from "./rpc/client.js";
export { Input as HeadInput, Output as HeadOutput } from "./type.js";
export { make_input as make_head_input, make_output_ok as make_head_output_ok } from "./tool/index.js";
...
export async function head<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("web-client", "head");
