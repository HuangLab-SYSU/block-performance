...
export async function rpc_head<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_head");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/web-client/head`,
                data: input
            },
            {
