...
export { rpc_get_text } from "./rpc/client.js";
export { Input as GetTextInput, Output as GetTextOutput } from "./type.js";
export { make_input as make_get_text_input, make_output_ok as make_get_text_output_ok } from "./tool/index.js";
...
export async function get_text<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("web-client", "get-text");
