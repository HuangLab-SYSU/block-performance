...
export async function rpc_get_file<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_get_file");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/web-client/get-file`,
                data: input
            },
            {
