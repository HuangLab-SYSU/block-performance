...
export { rpc_proxy_url_parse } from "./rpc/client.js";
export { Input as ProxyUrlParseInput, Output as ProxyUrlParseOutput } from "./type.js";
export { make_input as make_proxy_url_parse_input, make_output_ok as make_proxy_url_parse_output_ok } from "./tool/index.js";
...
export async function proxy_url_parse<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("web-client", "proxy-url-parse");
