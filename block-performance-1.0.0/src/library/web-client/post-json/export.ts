...
export { rpc_post_json } from "./rpc/client.js";
export { Input as PostJsonInput, Output as PostJsonOutput } from "./type.js";
export { make_input as make_post_json_input, make_output_ok as make_post_json_output_ok } from "./tool/index.js";
...
export async function post_json<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("web-client", "post-json");
