...
export async function rpc_file_read_base64<R>(plog: Logger, opts: { server: string; input: Input }, cb: Callback<R>): Promise<R> {
    const log = plog.sub("rpc_file_read_base64");
    ...
    try {
        ...
        return await post_json(
            log,
            {
                url: `${prefix}/library/file-system/file-read-base64`,
                data: input
            },
            {
