...
export { rpc_file_read_base64 } from "./rpc/client.js";
export { Input as FileReadBase64Input, Output as FileReadBase64Output } from "./type.js";
export { make_input as make_file_read_base64_input, make_output_ok as make_file_read_base64_output_ok } from "./tool/index.js";
...
export async function file_read_base64<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "file-read-base64");
