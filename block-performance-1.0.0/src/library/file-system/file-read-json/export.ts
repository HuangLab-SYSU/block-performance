...
export { rpc_file_read_json } from "./rpc/client.js";
export { Input as FileReadJsonInput, Output as FileReadJsonOutput } from "./type.js";
export { make_input as make_file_read_json_input, make_output_ok as make_file_read_json_output_ok } from "./tool/index.js";
...
export async function file_read_json<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "file-read-json");
