...
export { rpc_directory_ls } from "./rpc/client.js";
export { Input as DirectoryLsInput, Output as DirectoryLsOutput } from "./type.js";
export {
    make_input as make_directory_ls_input,
    make_output_empty as make_directory_ls_output_empty,
    make_output_ok as make_directory_ls_output_ok
} from "./tool/index.js";
...
export async function directory_ls<R>(plog: Logger, input: InputEx, cb: Callback<R>): Promise<R> {
    const log = plog.sub_library_function("file-system", "directory-ls");
